...
while ((currentContainer<=containerNum)); do
	...
	while ((currentRack<=rackNum)); do
		...
		while ((currentMiner<=minerNum)); do
				...
				echo 10.$currentContainer.$currentRack.$currentMiner >> /home/skylerd/scripts/containerList/$siteName/$siteName
				echo 10.$currentContainer.$currentRack.$currentMiner >> /home/skylerd/scripts/containerList/$siteName/C$currentContainer/C$currentContainer
				echo 10.$currentContainer.$currentRack.$currentMiner >> /home/skylerd/scripts/containerList/$siteName/C$currentContainer/R$currentRack
				let currentMiner++
		done
		let currentRack++
	done
